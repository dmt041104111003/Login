...
namespace Login
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            #region "icon default"
            string eyeOpenIconPath = @"E:\bt lập trình trực quan\Login\Login\image\eye.png"; 
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string fontPath = @"E:\bt lập trình trực quan\Login\Login\font\Inter_18pt-Regular.ttf";
        ...
        private void btnTogglePassword_Click(object sender, EventArgs e)
        {
            ...
            string eyeOpenIconPath = @"E:\bt lập trình trực quan\Login\Login\image\eye.png"; 
            string eyeClosedIconPath = @"E:\bt lập trình trực quan\Login\Login\image\hidden.png"; 
            btnTogglePassword.Image = Image.FromFile(eyeOpenIconPath);
